  ...
  try {
    ...
    try {
      ...
      const emailHTML = `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Hai richiesto il recupero della password per il tuo account Pannello di Controllo SGI.</p>
      ...
      const info = await transporter.sendMail({
        from: `"Pannello di Controllo SGI" <${SMTP_USER || "noreply@isodocmanager.it"}>`,
        to: user.email,
        subject: "Recupero password - Pannello di Controllo SGI",
