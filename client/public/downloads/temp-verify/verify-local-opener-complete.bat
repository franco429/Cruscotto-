...
if %GDRIVE_FOUND% equ 1 (
    ...
    echo ⚠️  WARN: Google Drive Desktop non trovato
...
if exist "%LOG_DIR%" (
    ...
    echo ⚠️  WARN: Directory log non trovata
...
if %errorLevel% equ 0 (
    ...
    echo ⚠️  WARN: Regola firewall non trovata
...
if %errorLevel% equ 0 (
    ...
    if %errorLevel% equ 0 (
        ...
        echo ⚠️  WARN: API risponde ma apertura non riuscita
...
if %TESTS_FAILED% equ 0 (
    ...
    color 0E
    echo ⚠️  QUASI PRONTO! Alcuni test minori falliti.
...
if %TESTS_FAILED% gtr 0 (
    ...
    echo 1. Testa l'apertura di un documento da SGI Cruscotto
